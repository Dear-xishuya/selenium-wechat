...
public class ContactPage extends BasePage {
	...
	@FindBy(linkText = "定向4期")
	private WebElement dx4;

	@FindBy(linkText = "定向4期2")
	private WebElement dx42;
	 ...
	 * @return	ContactPage
	 */
	public ContactPage updateDepartInfo(String newDepartName){
		click(dx4);
		click(dropDownBtn);
	 ...
	 * @return	ContactPage
	 */
	public ContactPage deletePartInfo(){
		click(dx42);
		click(dropDownBtn);
		click(deleteDeptBtn);
